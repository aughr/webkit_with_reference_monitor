...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToString(ExecState* exec)
{
    ...
    return JSValue::encode(jsMakeNontrivialString(exec, date, " ", time), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToISOString(ExecState* exec)
{
    ...
    return JSValue::encode(jsNontrivialString(exec, buffer), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToDateString(ExecState* exec)
{
    ...
    DateConversionBuffer date;
    formatDate(*gregorianDateTime, date);
    return JSValue::encode(jsNontrivialString(exec, date), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToTimeString(ExecState* exec)
{
    ...
    DateConversionBuffer time;
    formatTime(*gregorianDateTime, time);
    return JSValue::encode(jsNontrivialString(exec, time), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToLocaleString(ExecState* exec)
{
    ...
    DateInstance* thisDateObj = asDateInstance(thisValue); 
    return JSValue::encode(formatLocaleDate(exec, thisDateObj, thisDateObj->internalNumber(), LocaleDateAndTime), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToLocaleDateString(ExecState* exec)
{
    ...
    DateInstance* thisDateObj = asDateInstance(thisValue); 
    return JSValue::encode(formatLocaleDate(exec, thisDateObj, thisDateObj->internalNumber(), LocaleDate), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToLocaleTimeString(ExecState* exec)
{
    ...
    DateInstance* thisDateObj = asDateInstance(thisValue); 
    return JSValue::encode(formatLocaleDate(exec, thisDateObj, thisDateObj->internalNumber(), LocaleTime), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetTime(ExecState* exec)
{
    ...
    return JSValue::encode(asDateInstance(thisValue)->internalValue(), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetFullYear(ExecState* exec)
{
    ...
    return JSValue::encode(jsNumber(1900 + gregorianDateTime->year), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetMonth(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->month), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetDate(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->monthDay), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetDay(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->weekDay), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetHours(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->hour), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetMinutes(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->minute), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetSeconds(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->second), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetMilliSeconds(ExecState* exec)
{
    ...
    return JSValue::encode(jsNumber(ms), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetTimezoneOffset(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(-gregorianDateTime->utcOffset / minutesPerHour), exec, thisValue.securityLabel());
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncSetTime(ExecState* exec)
{
    ...
    thisDateObj->mergeSecurityLabel(exec, exec->argument(0).securityLabel());
    return JSValue::encode(result, exec, exec->argument(0).securityLabel());
}
...
static EncodedJSValue setNewValueFromTimeArgs(ExecState* exec, int numArgsToUse, bool inputIsUTC)
{
    ...
    return JSValue::encode(result, exec, label);
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetYear(ExecState* exec)
{
    ...
    return JSValue::encode(jsNumber(gregorianDateTime->year), exec, thisValue.securityLabel());
}
