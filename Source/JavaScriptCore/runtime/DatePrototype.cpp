...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToString(ExecState* exec)
{
    ...
    return JSValue::encode(jsMakeNontrivialString(exec, date, " ", time), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToISOString(ExecState* exec)
{
    ...
    return JSValue::encode(jsNontrivialString(exec, buffer), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToDateString(ExecState* exec)
{
    ...
    DateConversionBuffer date;
    formatDate(*gregorianDateTime, date);
    return JSValue::encode(jsNontrivialString(exec, date), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToTimeString(ExecState* exec)
{
    ...
    DateConversionBuffer time;
    formatTime(*gregorianDateTime, time);
    return JSValue::encode(jsNontrivialString(exec, time), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToLocaleString(ExecState* exec)
{
    ...
    DateInstance* thisDateObj = asDateInstance(thisValue); 
    return JSValue::encode(formatLocaleDate(exec, thisDateObj, thisDateObj->internalNumber(), LocaleDateAndTime), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToLocaleDateString(ExecState* exec)
{
    ...
    DateInstance* thisDateObj = asDateInstance(thisValue); 
    return JSValue::encode(formatLocaleDate(exec, thisDateObj, thisDateObj->internalNumber(), LocaleDate), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncToLocaleTimeString(ExecState* exec)
{
    ...
    DateInstance* thisDateObj = asDateInstance(thisValue); 
    return JSValue::encode(formatLocaleDate(exec, thisDateObj, thisDateObj->internalNumber(), LocaleTime), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetTime(ExecState* exec)
{
    ...
    return JSValue::encode(asDateInstance(thisValue)->internalValue(), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetFullYear(ExecState* exec)
{
    ...
    return JSValue::encode(jsNumber(1900 + gregorianDateTime->year), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetMonth(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->month), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetDate(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->monthDay), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetDay(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->weekDay), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetHours(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->hour), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetMinutes(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->minute), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetSeconds(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(gregorianDateTime->second), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetMilliSeconds(ExecState* exec)
{
    ...
    return JSValue::encode(jsNumber(ms), exec, thisValue.isTainted(exec));
}
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetTimezoneOffset(ExecState* exec)
{
    ...
    if (!gregorianDateTime)
        return JSValue::encode(jsNaN());
    return JSValue::encode(jsNumber(-gregorianDateTime->utcOffset / minutesPerHour), exec, thisValue.isTainted(exec));
}
...
static EncodedJSValue setNewValueFromTimeArgs(ExecState* exec, int numArgsToUse, bool inputIsUTC)
{
    ...
    bool tainted = thisValue.isTainted(exec);
    for (int i = 0; i < numArgsToUse && !tainted; i++) {
        if (exec->argument(i).hasTaintAnywhere(exec))
            tainted = true;
    }
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncSetYear(ExecState* exec)
{
    ...
    bool tainted = thisValue.isTainted(exec) || exec->argument(0).hasTaintAnywhere(exec);
...
EncodedJSValue JSC_HOST_CALL dateProtoFuncGetYear(ExecState* exec)
{
    ...
    return JSValue::encode(jsNumber(gregorianDateTime->year), exec, thisValue.isTainted(exec));
}
